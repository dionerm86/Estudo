<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SelNotaFiscalConsumidorReferenciada.aspx.cs" Inherits="Glass.UI.Web.Utils.SelNotaFiscalConsumidorReferenciada"
    Title="Selecione a Nota Fiscal de Consumidor" MasterPageFile="~/Layout.master" %>
...
<asp:Content ID="pagina" runat="server" ContentPlaceHolderID="Pagina">
    ...
    <script type="text/javascript">
        ...
        function ObtemNumeroNFGrid(numeroNF, idNfe) {
            var dado = SelNotaFiscalConsumidorReferenciada.ObtemNumeroNF(numeroNF, idNfe).value;
            var notas = '';
            if (dado != '' && dado != null)
                notas = dado.split(",")
                ...
                <colo:VirtualObjectDataSource culture="pt-BR" ID="odsNf" runat="server" DataObjectTypeName="Glass.Data.Model.NotaFiscal"
                    ...
                    <SelectParameters>
                        ...
                        <asp:ControlParameter ControlID="txtNumPedido" Name="idPedido" PropertyName="Text"
                            Type="UInt32" />
                        <asp:Parameter Name="modelo" Type="String" DefaultValue="65"/>
