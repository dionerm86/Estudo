<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetMotivoCancLib.aspx.cs"
    Inherits="Glass.UI.Web.Utils.SetMotivoCancLib" Title="Cancelamento de Liberação de Pedido"
...
<asp:Content ID="pagina" runat="server" ContentPlaceHolderID="Pagina">
    ...
    <script type="text/javascript">
        function validate()
        {
            ...
            if (!confirm("Tem certeza que deseja cancelar esta Liberação de Pedido?"))
                return false;
