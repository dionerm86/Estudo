<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetMotivoCancMedicao.aspx.cs"
    Inherits="Glass.UI.Web.Utils.SetMotivoCancMedicao" Title="Cancelamento de Medição" MasterPageFile="~/Layout.master" %>
...
<asp:Content ID="pagina" runat="server" ContentPlaceHolderID="Pagina">
    ...
    <script type="text/javascript">
        function validate()
        {
            ...
            if (!confirm("Tem certeza que deseja cancelar esta Medição?"))
                return false;
