            ...
            try
            {
                ...
                foreach (var item in itens)
                {
                    ...
                    if (valorAlterado)
                    {
                        ...
                        if (idConfig == Config.ConfigEnum.UsarPercentualBonificacaoCliente && (bool)valor && Liberacao.DadosLiberacao.LiberarPedidoProdutos)
                        {
                            return "Erro|Não é possivel habilitar a opção de 'Usar percentual de bonificação para o cliente' caso a config 'Permitir liberação parcial de pedidos' esteja habilitada";
                        }
                    }
