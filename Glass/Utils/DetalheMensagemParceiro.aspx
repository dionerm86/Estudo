<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DetalheMensagemParceiro.aspx.cs"
    Inherits="Glass.UI.Web.Utils.DetalheMensagemParceiro" Title="Mensagem" MasterPageFile="~/Layout.master" %>
                ...
                <asp:DetailsView ID="dtvMensagem" runat="server" AutoGenerateRows="False" CellPadding="4"
                    ...
                    <Fields>
                        ...
                        <asp:TemplateField HeaderText="Descrição" SortExpression="Descricao">
                            <ItemTemplate>
                                <asp:Label ID="Label1" runat="server" Text='<%# Eval("Descricao") != null ? Eval("Descricao").ToString().Replace("\n", "<br/>") : String.Empty %>'></asp:Label>
                            </ItemTemplate>
                            <EditItemTemplate>
