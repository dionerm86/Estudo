                    ...
                    <tr>
                        <td width="80%" valign="top">
                            <table style="width: 100%">
                                <tr>
                                    <td align="center">
                                        <asp:Button ID="btnNovoCalculo" runat="server" Text="Novo Cálculo" OnClientClick="openWindow(600, 750, 'SelModelo.aspx?apenasVidro=' + (FindControl('hdfApenasVidros', 'input') != null ? FindControl('hdfApenasVidros', 'input').value : 'false')); return false;" />
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center">
