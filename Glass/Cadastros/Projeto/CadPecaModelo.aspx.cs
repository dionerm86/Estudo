...
namespace Glass.UI.Web.Cadastros.Projeto
{
    public partial class CadPecaModelo : System.Web.UI.Page
    {
        ...
        protected void btnSalvarInsercaoRapida_Click(object sender, EventArgs e)
        {
            try
            {
                Glass.Data.Model.PecaProjetoModelo pecaProjetoModelo;
                int largura;
                int altura;
                int largura03MM;
                int altura03MM;
                ...
                {
                    uint idPecaProjetomodelo = Glass.Conversoes.StrParaUint(((HiddenField)row.Cells[38].FindControl("hdfIdPecaProjMod")).Value);
                    pecaProjetoModelo = PecaProjetoModeloDAO.Instance.ObtemPeloId(idPecaProjetomodelo);

                    if (!ExibirFolgaPorEspessura())
                    {
                        largura = Glass.Conversoes.StrParaInt(((TextBox)row.Cells[20].FindControl("txtLarguraInsercaoRapida")).Text);
                        altura = Glass.Conversoes.StrParaInt(((TextBox)row.Cells[21].FindControl("txtAlturaInsercaoRapida")).Text);
                    ...
                    {
                        largura03MM = Glass.Conversoes.StrParaInt(((TextBox)row.Cells[22].FindControl("txtLargura03MMInsercaoRapida")).Text);
                        altura03MM = Glass.Conversoes.StrParaInt(((TextBox)row.Cells[23].FindControl("txtAltura03MMInsercaoRapida")).Text);
                        largura04MM = Glass.Conversoes.StrParaInt(((TextBox)row.Cells[24].FindControl("txtLargura04MMInsercaoRapida")).Text);
                        altura04MM = Glass.Conversoes.StrParaInt(((TextBox)row.Cells[25].FindControl("txtAltura04MMInsercaoRapida")).Text);
                        largura05MM = Glass.Conversoes.StrParaInt(((TextBox)row.Cells[26].FindControl("txtLargura05MMInsercaoRapida")).Text);
                        altura05MM = Glass.Conversoes.StrParaInt(((TextBox)row.Cells[27].FindControl("txtAltura05MMInsercaoRapida")).Text);
                        largura06MM = Glass.Conversoes.StrParaInt(((TextBox)row.Cells[28].FindControl("txtLargura06MMInsercaoRapida")).Text);
                        altura06MM = Glass.Conversoes.StrParaInt(((TextBox)row.Cells[29].FindControl("txtAltura06MMInsercaoRapida")).Text);
                        largura08MM = Glass.Conversoes.StrParaInt(((TextBox)row.Cells[30].FindControl("txtLargura08MMInsercaoRapida")).Text);
                        altura08MM = Glass.Conversoes.StrParaInt(((TextBox)row.Cells[31].FindControl("txtAltura08MMInsercaoRapida")).Text);
                        largura10MM = Glass.Conversoes.StrParaInt(((TextBox)row.Cells[32].FindControl("txtLargura10MMInsercaoRapida")).Text);
                        altura10MM = Glass.Conversoes.StrParaInt(((TextBox)row.Cells[33].FindControl("txtAltura10MMInsercaoRapida")).Text);
                        largura12MM = Glass.Conversoes.StrParaInt(((TextBox)row.Cells[34].FindControl("txtLargura12MMInsercaoRapida")).Text);
                        altura12MM = Glass.Conversoes.StrParaInt(((TextBox)row.Cells[35].FindControl("txtAltura12MMInsercaoRapida")).Text);
                        ...
                        pecaProjetoModelo.Largura = largura06MM;
                        pecaProjetoModelo.Altura = altura06MM;
