<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SelModelo.aspx.cs" Inherits="Glass.UI.Web.Cadastros.Projeto.SelModelo"
...
<asp:Content ID="pagina" runat="server" ContentPlaceHolderID="Pagina">
    ...
    <script type="text/javascript">
        ...
        function selModelo(lnkSelecionar)
        {
            ...
            {
                alert("Informe a cor do alumínio.");
                click = false;
                return false;
            }

            if (idCorFerragem == "" && parceiro == false)
            {
                alert("Informe a cor da ferragem.");
                click = false;
                return false;
            }
            ...
            // A janela já é fechada no método acima
            closeWindow();
        }
