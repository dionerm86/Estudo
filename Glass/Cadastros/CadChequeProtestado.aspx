<%@ Page Title="Controle de Cheques Protestados" Language="C#" MasterPageFile="~/Painel.master"
    AutoEventWireup="true" CodeBehind="CadChequeProtestado.aspx.cs" Inherits="Glass.UI.Web.Cadastros.CadChequeProtestado" %>
            ...
            <td align="center">
                <asp:GridView GridLines="None" ID="grdCheque" runat="server" AllowPaging="True" AllowSorting="True"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                <a href="#" onclick="openWindow(150, 450, '../Utils/SetMotivoCheque.aspx?tipo=2&idCheque=<%# Eval("IdCheque") %>')">
                                    Protestado</a>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
