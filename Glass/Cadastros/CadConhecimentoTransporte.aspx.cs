    ...
    public partial class CadConhecimentoTransporte : System.Web.UI.Page
    {
        ...
        protected void lnkAddChaveAcesso_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                chaveAcessoCte.FinalidadeChaveAcesso = (FinalidadeChaveAcesso)((DropDownList)this.grdChavesAcesso.FooterRow.FindControl("drpFinalidadeChaveAcesso")).SelectedIndex;
