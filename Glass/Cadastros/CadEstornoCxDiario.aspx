<%@ Page Title="Estorno de Movimentação Caixa Diário" Language="C#" MasterPageFile="~/Painel.master" AutoEventWireup="true" CodeBehind="CadEstornoCxDiario.aspx.cs" Inherits="Glass.UI.Web.Cadastros.CadEstornoCxDiario" %>
                        ...
                        <td align="center">
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <asp:ImageButton ID="lnkBuscarCreditoRetirada" runat="server" 
                                            ImageUrl="~/Images/Pesquisar.gif" ToolTip="Busca retirada" 
                                            onclick="lnkBuscarCreditoRetirada_Click" />
                                    </td>
                                </tr>
                            </table>
                        </td>
