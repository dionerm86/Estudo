<%@ Page Title="Creditar Cx. Geral" Language="C#" MasterPageFile="~/Painel.master" AutoEventWireup="true" CodeBehind="CadCreditarCxGeral.aspx.cs" Inherits="Glass.UI.Web.Cadastros.CadCreditarCxGeral" %>
...
<script type="text/javascript">
    ...
    function onSave(btn) {
        ...
        var response = CadCreditarCxGeral.Transferir(idConta, valor, formaEntrada, obs).value;
        ...
        <tr>
            <td align="center">
                ...
                <asp:Button ID="btnTransferir" runat="server" 
                    Text="Creditar" OnClientClick="return onSave(this);" />
