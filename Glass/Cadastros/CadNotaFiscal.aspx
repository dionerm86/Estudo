...
<asp:Content ID="Content1" ContentPlaceHolderID="Conteudo" runat="Server">
    ...
    function validarDataHora()
    {
        ...
        if (horaSaida == "") {
        alert(horaEmissao== "" ?
            "Os horários de saída e entrada devem ser informados!" : "O horário de saída deve ser informado!");
        return false;
        }
            
        if (horaEmissao == "") {
            alert("O horário de emissão deve ser informado!");
            return false;
        }
        ...
        if (!horaSaida.match(horaValida)) {
            alert(!horaEmissao.match(horaValida) ?
                "O valores " + horaSaida + " e " + horaEmissao + " não são válidos para os campos do horário de saída e emissão !" : "O valor " + horaSaida + " para o campo do horário de saída!");
            return false;
        }
            
        if (!horaEmissao.match(horaValida)) {
                alert("O valor " + horaEmissao + " para o campo do horário de emissão!");
            return false;
        }
