<%@ Page Title="Nova Mensagem" Language="C#" MasterPageFile="~/Painel.master" AutoEventWireup="true" CodeBehind="CadMensagem.aspx.cs" Inherits="Glass.UI.Web.Cadastros.CadMensagem" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Conteudo" Runat="Server">
    ...
    function enviarMsg() {
        ...
        var response = CadMensagem.Enviar(assunto, dest, mensagem).value;
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td align="left" nowrap="nowrap">
                            <asp:TextBox ID="txtDest" runat="server" Width="300px" Rows="2" 
                                TextMode="MultiLine" Enabled="false" ReadOnly="True"></asp:TextBox>
                            <a href="#" onclick="openWindow(500, 700, '../Utils/SelDestinatario.aspx');">
                                <img src="../Images/pesquisar.gif" border="0px"></a>
                            <a href="#" onclick="limparDest(); return false;">
