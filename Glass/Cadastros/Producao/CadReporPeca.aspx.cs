        ...
        protected void grdProdutos_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                if (e.CommandName == "Marcar")
                {
                    ...
                    ProdutoPedidoProducaoDAO.Instance.MarcarPecaRepostaComTransacao(null, e.CommandArgument.ToString().Split(';')[0], Glass.Conversoes.StrParaUint(drpSetor.SelectedValue),
