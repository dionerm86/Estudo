<%@ Page Title="Crédito Conta Bancária" Language="C#" MasterPageFile="~/Painel.master"
    AutoEventWireup="true" CodeBehind="CadCreditoContaBanco.aspx.cs" Inherits="Glass.UI.Web.Cadastros.CadCreditoContaBanco" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Conteudo" runat="Server">
    ...
    function onSave(btn) {
        ...
        var response = CadCreditoContaBanco.CreditarValor(idConta, idContaBanco, valor, data, obs).value;
    ...
    <table style="width: 100%">
        <tr>
            <td align="center">
                ...
                <br />
                <br />
                <asp:Button ID="btnCreditarValor" runat="server" OnClientClick="return onSave(this);"
                    Text="Creditar Valor" />
