        ...
        <transicao :exibir="exibirPedido">
            <div v-if="editando || inserindo">
                <section class="edicao">
                    ...
                    <span>
                        <lista-selecao-id-valor :item-selecionado.sync="vendedorAtual" :funcao-recuperar-itens="obterVendedores" :disabled="!configuracoes.alterarVendedor" @change.prevent="alterarVendedor" required></lista-selecao-id-valor>
                    </span>
