<%@ Page Title="Lançar Crédito de Funcionário" Language="C#" MasterPageFile="~/Painel.master" AutoEventWireup="true" CodeBehind="CadLancarCreditoFunc.aspx.cs" Inherits="Glass.UI.Web.Cadastros.CadLancarCreditoFunc" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Conteudo" Runat="Server">
    ...
    <table>
        ...
        <tr>
            <td align="center">
                <br />
                <asp:Button ID="btnConfirmar" runat="server" Text="Creditar" 
