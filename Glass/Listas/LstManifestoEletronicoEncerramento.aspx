<%@ Page Title="Encerramento de MDFe" Language="C#" MasterPageFile="~/Painel.master" AutoEventWireup="true"
    CodeBehind="LstManifestoEletronicoEncerramento.aspx.cs" Inherits="Glass.UI.Web.Listas.LstManifestoEletronicoEncerramento" %>
                    ...
                    <tr>
                        ...
                        <td>
                            <sync:CheckBoxListDropDown ID="cbdSituacao" runat="server" CheckAll="False" Title="Todas">
                                ...
                                <asp:ListItem Value="7">Processo de encerramento</asp:ListItem>
                                <asp:ListItem Value="10">Falha ao encerrar</asp:ListItem>
        ...
        <tr>
            <td align="center">
                <asp:GridView ID="grdManifestoEletronico" runat="server" GridLines="None" AllowPaging="true" AllowSorting="true" AutoGenerateColumns="false" CssClass="gridStyle"
                    ...
                    OnRowDataBound="grdManifestoEletronico_RowDataBound" OnRowCommand="grdManifestoEletronico_RowCommand">
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:LinkButton ID="lnkEncerrar" runat="server" Text="Encerrar" Visible='<%# Eval("EncerrarVisible") %>'
                                    OnClientClick="if (!confirm('Deseja encerrar o manifesto eletronico?')) return false;"
                                    CommandName="Encerrar" CommandArgument='<%# Eval("IdManifestoEletronico") %>'></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
            ...
            <td>
                <colo:VirtualObjectDataSource ID="odsManifestoEletronico" runat="server" Culture="pt-BR"
                    ...
                    <SelectParameters>
                        ...
                        <asp:ControlParameter ControlID="cbdSituacao" Name="situacoes" PropertyName="SelectedValue" DefaultValue="2,7,10" />
