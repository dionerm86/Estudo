<%@ Page Title="Fixação do Vidro" Language="C#" MasterPageFile="~/Painel.master" AutoEventWireup="true" CodeBehind="LstFixacaoVidro.aspx.cs" Inherits="Glass.UI.Web.Listas.LstFixacaoVidro" %>
            ...
            <td align="center">
                <asp:GridView ID="grdFixacaoVidro" runat="server" SkinID="gridViewEditable"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Cód. Fixação" SortExpression="IdFixacaoVidro">
                            <EditItemTemplate>
