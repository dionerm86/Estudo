<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Painel.master" CodeBehind="LstCTeInut.aspx.cs"
    Inherits="Glass.UI.Web.Listas.LstCTeInut" Title="Inutilização de CTe" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Conteudo" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function openMotivoInut(idCte) {
            ...
            var win = window.open("../Utils/SetMotivoInutCTe.aspx?idCte=" + idCte, "popup" + momentoAtual.getSeconds(), 'width=' + largura + ',height=' + altura + ',left=' + scrX + ',top=' + scrY);
    ...
    <div class="grid">
        <asp:GridView GridLines="None" ID="grdCte" runat="server" AllowPaging="True" AllowSorting="True"
            ...
            <Columns>
                <asp:TemplateField>
                    <ItemTemplate>
                        <a href="#" onclick="openMotivoInut('<%# Eval("IdCte") %>');return false;">Inutilizar</a>
                    </ItemTemplate>
        ...
        <colo:VirtualObjectDataSource culture="pt-BR" ID="odsCte" runat="server" DataObjectTypeName="WebGlass.Business.ConhecimentoTransporte.Entidade.Cte"
            ...
            >
            <SelectParameters>
                <asp:ControlParameter ControlID="txtNumCte" Name="numeroCte" PropertyName="Text" Type="Int32" />
                <asp:Parameter Name="idLoja" Type="Int32" />
                <asp:ControlParameter ControlID="cboSituacao" Name="situacao" PropertyName="SelectedValue" Type="String" DefaultValue="1,3,9,10,11,12" />
                <asp:ControlParameter ControlID="drpCfop" Name="idCfop" PropertyName="SelectedValue" Type="UInt32" />
                <asp:ControlParameter ControlID="drpFormaPagto" Name="formaPagto" PropertyName="SelectedValue" Type="Int32" />
                <asp:ControlParameter ControlID="drpTipoEmissao" Name="tipoEmissao" PropertyName="SelectedValue" Type="Int32" />
                <asp:ControlParameter ControlID="drpTipoCte" Name="tipoCte" PropertyName="SelectedValue" Type="Int32" />
                <asp:ControlParameter ControlID="drpTipoServico" Name="tipoServico" PropertyName="SelectedValue" Type="Int32" />
                <asp:ControlParameter ControlID="ctrlDataIni" Name="dataEmiIni" PropertyName="DataString" Type="String" />
