<%@ Page Title="Cancelamento de Nota Fiscal" Language="C#" MasterPageFile="~/Painel.master" AutoEventWireup="true"
    CodeBehind="LstNotaFiscalCanc.aspx.cs" Inherits="Glass.UI.Web.Listas.LstNotaFiscalCanc" %>
        ...
        <tr>
            <td align="center">
                <asp:GridView GridLines="None" ID="grdNf" runat="server" AllowPaging="True" AllowSorting="True" 
                    AutoGenerateColumns="False" DataSourceID="odsNf" CssClass="gridStyle"
                    PagerStyle-CssClass="pgr" AlternatingRowStyle-CssClass="alt" EditRowStyle-CssClass="edit"
                    DataKeyNames="IdNf" EmptyDataText="Nenhum Nota Fiscal encontrada.">
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
                                <a href="#" onclick="openMotivoCanc('<%# Eval("IdNf") %>');return false;">Cancelar</a>
                            </ItemTemplate>
                ...
                <colo:VirtualObjectDataSource culture="pt-BR" ID="odsNf" runat="server" DataObjectTypeName="Glass.Data.Model.NotaFiscal"
                    DeleteMethod="Delete" SelectMethod="GetListCanc" TypeName="Glass.Data.DAL.NotaFiscalDAO"
                    EnablePaging="True" MaximumRowsParameterName="pageSize" SelectCountMethod="GetCountCanc"
