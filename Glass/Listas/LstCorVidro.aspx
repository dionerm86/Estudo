<%@ Page Title="Cores do Vidro" Language="C#" MasterPageFile="~/Painel.master" AutoEventWireup="true"
    CodeBehind="LstCorVidro.aspx.cs" Inherits="Glass.UI.Web.Listas.LstCorVidro" EnableViewState="false" EnableViewStateMac="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Conteudo" runat="Server">
    <div id="app">
        <section>
            <lista-paginada ref="lista" :funcao-recuperar-itens="obterLista" :ordenacao="ordenacao" mensagem-lista-vazia="Nenhuma cor de vidro encontrada"
                ...
                <template slot="itemEditando">
                    ...
                    <td>{{ corVidro.id }}</td>
                    <td>
                        <input type="text" v-model="corVidro.descricao" maxlength="30" style="width: 150px" required />
                    </td>
                    <td>
                        <input type="text" v-model="corVidro.sigla" maxlength="5" style="width: 50px" required />
                    </td>
                </template>
                <template slot="itemIncluir">
                    <td style="white-space: nowrap">
                        <button v-on:click.prevent="iniciarCadastro" title="Nova cor de vidro..." v-if="!inserindo">
                    ...
                    <td></td>
                    <td>
                        <input type="text" v-model="corVidro.descricao" maxlength="30" style="width: 150px" v-if="inserindo" required />
                    </td>
                    <td>
                        <input type="text" v-model="corVidro.sigla" maxlength="5" style="width: 50px" v-if="inserindo" required />
                    </td>
                </template>
            </lista-paginada>
        </section>
     ...
     <asp:ScriptManager runat="server" LoadScriptsBeforeUI="False">
        <Scripts>
            <asp:ScriptReference Path="~/Vue/CoresVidro/Componentes/LstCoresVidro.js" />
        </Scripts>
    </asp:ScriptManager>
</asp:Content>
