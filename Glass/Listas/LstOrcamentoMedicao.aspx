<%@ Page Title="Orçamentos Medição" Language="C#" MasterPageFile="~/Painel.master" AutoEventWireup="true" CodeBehind="LstOrcamentoMedicao.aspx.cs" Inherits="Glass.UI.Web.Listas.LstOrcamentoMedicao" %>
        ...
        <tr>
            <td align="center">
                            <table>
                                <tr>
                                    <td align="right">
                                        <asp:Label ID="Label12" runat="server" ForeColor="#0066FF" Text="Num. Medição"></asp:Label></td>
                                    <td align="right">
                        ...
                        <td align="right">
                            <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/Images/Pesquisar.gif"
                                ToolTip="Pesquisar" onclick="imgPesq_Click" />
                                    ...
                                    <td align="right">
                                        <asp:Label ID="Label10" runat="server" ForeColor="#0066FF" 
                                            Text="Período Finalizada"></asp:Label>
                                    </td>
                                    <td nowrap="nowrap">
                            ...
                            <table>
                                <tr>
                                    <td>
                                        <asp:Label ID="Label1" runat="server" ForeColor="#0066FF" Text="Medidor"></asp:Label>&nbsp;</td>
                                    <td>
                                        <asp:TextBox ID="txtNumMedidor" runat="server" Width="50px" 
                                            onblur="getMedidor(this);"></asp:TextBox>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <asp:ImageButton ID="imgPesqMedidor" runat="server" ImageUrl="~/Images/Pesquisar.gif" 
                                            OnClientClick="getMedidor(FindControl('txtNumMedidor', 'input'));" 
                                            ToolTip="Pesquisar" onclick="imgPesq_Click" />
                                    </td>
                                    <td>
        ...
        <tr>
            <td align="center">
                <asp:GridView GridLines="None" ID="grdOrcamento" runat="server" AllowPaging="True" 
                    ...
                    DataKeyNames="IdOrcamento" DataSourceID="odsOrcamento">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="NomeFuncAbrv" HeaderText="Funcionário" 
                            SortExpression="NomeFuncionario" />
                        <asp:BoundField DataField="TelCliente" HeaderText="Tel. Res." 
                            SortExpression="TelCliente" />
                        <asp:BoundField DataField="Total" HeaderText="Total" 
                            SortExpression="Total" DataFormatString="{0:C}" >
                        <ItemStyle Wrap="False" />
                        </asp:BoundField>
                        <asp:BoundField DataField="DataCad" HeaderText="Data Orçamento" 
                            SortExpression="DataCad" DataFormatString="{0:d}" />
                        <asp:BoundField DataField="DescrSituacao" HeaderText="Sit. Orçamento" 
                ...
                <colo:VirtualObjectDataSource culture="pt-BR" ID="odsOrcamento" runat="server" 
                    DataObjectTypeName="Glass.Data.Model.Orcamento" DeleteMethod="Delete" 
                    EnablePaging="True" MaximumRowsParameterName="pageSize" 
                    SelectCountMethod="GetOrcamentosMedicaoCount" SelectMethod="GetOrcamentosMedicao" 
                    SortParameterName="sortExpression" StartRowIndexParameterName="startRow" 
                    TypeName="Glass.Data.DAL.OrcamentoDAO">
                    <SelectParameters>
                        ...
                        <asp:ControlParameter ControlID="txtNumMedidor" Name="idMedidor" PropertyName="Text" 
                            Type="UInt32" />
                        <asp:ControlParameter ControlID="txtNomeMedidor" Name="nomeMedidor" 
                        ...
                        <asp:ControlParameter ControlID="txtDataIni" Name="dataFinIni" PropertyName="Text" 
                            Type="String" />
                        <asp:ControlParameter ControlID="txtDataFim" Name="dataFinFim" 
                            PropertyName="Text" Type="String" />
