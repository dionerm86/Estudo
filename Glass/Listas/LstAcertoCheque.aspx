<%@ Page Title="Acerto de Cheques Devolvidos/Abertos" Language="C#" MasterPageFile="~/Painel.master"
    AutoEventWireup="true" CodeBehind="LstAcertoCheque.aspx.cs" Inherits="Glass.UI.Web.Listas.LstAcertoCheque" EnableViewState="false" EnableViewStateMac="false" EnableEventValidation="false" %>
    ...
    <div id="app">
        ...
        <section class="links">
            <div>
                ...
                <span>
                    <a href="#" @click.prevent="abrirListaAcertosCheques(true)" title="Imprimir">
