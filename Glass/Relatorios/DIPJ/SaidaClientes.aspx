<%@ Page Title="DIPJ (Saída de Clientes)" Language="C#" MasterPageFile="~/Painel.master" AutoEventWireup="true" CodeBehind="SaidaClientes.aspx.cs" Inherits="Glass.UI.Web.Relatorios.DIPJ.SaidaClientes" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Conteudo" Runat="Server">
    <script type="text/javascript">
        function imprimir(exportarExcel) {
            ...
            openWindow(600, 800, '../RelBase.aspx?rel=DIPJSaidaClientes' + 
    ...
    <div style="margin-top: 20px;">
         <asp:GridView GridLines="None" runat="server" AutoGenerateColumns="False"
                    EnableViewState="false"
                    DataSourceID="odsSaidaClientes" CssClass="gridStyle" PagerStyle-CssClass="pgr" AlternatingRowStyle-CssClass="alt"
        ...
        <colo:VirtualObjectDataSource ID="odsSaidaClientes" Culture="pt-BR"
            runat="server" TypeName="Glass.Data.RelDAL.DipjDAO"
            SelectMethod="ObtemSaidaClientes" MaximumRowsParameterName="pageSize" EnableViewState="false"
            EnablePaging="true">
            <SelectParameters>
