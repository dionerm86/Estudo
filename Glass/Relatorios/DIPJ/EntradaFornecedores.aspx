<%@ Page Title="DIPJ (Entrada de Fornecedores)" Language="C#" MasterPageFile="~/Painel.master" AutoEventWireup="true" 
         CodeBehind="EntradaFornecedores.aspx.cs" Inherits="Glass.UI.Web.Relatorios.DIPJ.EntradaFornecedores" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Conteudo" Runat="Server">
    <script type="text/javascript">
        function imprimir(exportarExcel) {
            ...
            openWindow(600, 800, '../RelBase.aspx?rel=DIPJEntradaFornecedores' + 
    ...
    <div style="margin-top: 20px;">
         <asp:GridView GridLines="None" ID="grdEntradaForn" runat="server" AutoGenerateColumns="False"
                    EnableViewState="false"
                    DataSourceID="odsEntradaForn" CssClass="gridStyle" PagerStyle-CssClass="pgr" AlternatingRowStyle-CssClass="alt"
                    EditRowStyle-CssClass="edit" EmptyDataText="Nenhum registro encontrado."
                    AllowPaging="True">
            <PagerSettings PageButtonCount="20" />
            <Columns>
                <asp:BoundField HeaderText="Identificação" DataField="Id" />
        ...
        <colo:VirtualObjectDataSource ID="odsEntradaForn" Culture="pt-BR"
            runat="server" TypeName="Glass.Data.RelDAL.DipjDAO"
            SelectMethod="ObtemEntradaFornecedores" MaximumRowsParameterName="pageSize" EnableViewState="false"
            EnablePaging="true">
            <SelectParameters>
