<%@ Page Title="Monitoramento de Produção" Language="C#" AutoEventWireup="true" CodeBehind="PainelProducaoClassificacao.aspx.cs"
    Inherits="Glass.UI.Web.Relatorios.Producao.PainelProducaoClassificacao" MasterPageFile="~/PainelGraficos.master" ValidateRequest="false" %>
...
<asp:Content runat="server" ID="conteudo" ContentPlaceHolderID="Conteudo">
    ...
    <asp:DropDownList ID="drpClassificacao" runat="server" AppendDataBoundItems="True" DataSourceID="odsClassificacaoRoteiroProducao" AutoPostBack="true"
        DataTextField="Name" DataValueField="Id" >
        <asp:ListItem></asp:ListItem>
    </asp:DropDownList>
    <colo:VirtualObjectDataSource Culture="pt-BR" ID="odsClassificacaoRoteiroProducao" runat="server"                    
        SelectMethod="ObtemClassificacao" TypeName="Glass.PCP.Negocios.IClassificacaoRoteiroProducaoFluxo" >
