...
{
    public partial class PainelProducaoClassificacao : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Page.Title = "Monitoramento de Produção - " + drpClassificacao.SelectedItem;
        ...
        {
            return GraficoProdPerdaDiariaDAO.Instance.GetProdPerdaDiaClassificacao(drpClassificacao.SelectedValue.StrParaInt());
        }
        ...
        {
            var pp = PecasPendentesDAO.Instance.ProducaoPendenteClassificacao(DateTime.Today.AddDays(-9).ToString("yyyy-MM-dd"), 
                DateTime.Today.AddDays(-1).ToString("yyyy-MM-dd"), drpClassificacao.SelectedValue.StrParaInt());
        ...
        private void MontarGraficoProducaoDia()
        {
            ...
            if (chtProducaoDia != null)
            {
                ...
                var classificacao = Microsoft.Practices.ServiceLocation.ServiceLocator
                    ...
                    .ObtemClassificacao(drpClassificacao.SelectedValue.StrParaInt());
        ...
        private void MontarGraficoPerdaMensal()
        {
            ...
            var totM2Produzido = GraficoProdPerdaDiariaDAO.Instance.GetTotM2ProducaoMensalClassificacao(DateTime.Today.Month, DateTime.Today.Year, drpClassificacao.SelectedValue.StrParaInt());
            ...
            if (PCPConfig.PainelProducao.ExibirGraficoPerda)
            {
