<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RelEtiquetaVolume.aspx.cs"
    Inherits="Glass.UI.Web.Relatorios.RelEtiquetaVolume" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function load()
        {
            ...
            {
                case 1:
                    var obs = window.opener.document.getElementById("ctl00_Pagina_txtObservacoes");
                    if (obs != null)
