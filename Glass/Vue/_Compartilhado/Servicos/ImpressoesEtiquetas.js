...
Servicos.ImpressoesEtiquetas = (function (http) {
  ...
  const API_Individual = API + 'individual/';

  return {
    /**
     * Objeto com os serviços para a API de impressões individuais de etiquetas.
     */
    Individual: {
      /**
      ...
      obterLista: function (filtro, pagina, numeroRegistros, ordenacao) {
        return http().get(API_Individual.substr(0, API_Individual.length - 1), {
          params: Servicos.criarFiltroPaginado(filtro, pagina, numeroRegistros, ordenacao)
        });
      },

      /**
       * Recupera o objeto com as configurações utilizadas na tela de listagem de impressões individuais de etiquetas.
       * @returns {Promise} Uma promise com o resultado da busca.
       */
      obterConfiguracoesLista: function () {
        return http().get(API_Individual + 'configuracoes');
      }
    },
