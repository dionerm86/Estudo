...
{
    /// <summary>
    /// Enumeração com os tipos de log disponíveis.
    /// </summary>
    public enum TipoLog
    {
        /// <summary>
    ...
    public class LogAttribute : Attribute
    {
        ...
        public LogAttribute(string campo)
        ...
        /// </summary>
        /// <param name="campo">O nome do campo que aparecerá no Log. Pode ter até 30 caracteres.</param>
        public LogAttribute(TipoLog tipoLog, string campo)
        ...
        /// </summary>
        /// <param name="campo">O nome do campo que aparecerá no Log. Pode ter até 30 caracteres.</param>
        public LogAttribute(string campo, bool isCampoEFD)
        ...
        /// </summary>
        /// <param name="campo">O nome do campo que aparecerá no Log. Pode ter até 30 caracteres.</param>
        public LogAttribute(TipoLog tipoLog, string campo, bool isCampoEFD)
        ...
        public LogAttribute(string campo, string campoDescricaoModel, Type tipoDAO)
        ...
        /// <param name="campoDescricaoModel">O nome da propriedade da Model que contém a descrição.</param>
        /// <param name="tipoDAO">O tipo da DAO que contém a descrição.</param>
        public LogAttribute(TipoLog tipoLog, string campo, string campoDescricaoModel, Type tipoDAO)
        ...
        public LogAttribute(string campo, bool isCampoEFD, string campoDescricaoModel, Type tipoDAO)
        ...
        public LogAttribute(TipoLog tipoLog, string campo, bool isCampoEFD, string campoDescricaoModel, Type tipoDAO)
        ...
        public LogAttribute(string campo, string campoDescricaoModel, Type tipoDAO, string campoIdModel, string nomeMetodoDAO,
        ...
        /// <param name="incluirValorPrimeiroParametro">O valor do item deve ser incluído como o primeiro parâmetro?</param>
        /// <param name="parametrosMetodoDAO">Os parâmetros do método de retorno.</param>
        public LogAttribute(TipoLog tipoLog, string campo, string campoDescricaoModel, Type tipoDAO, string campoIdModel,
        ...
        /// <param name="incluirValorPrimeiroParametro">O valor do item deve ser incluído como o primeiro parâmetro?</param>
        /// <param name="parametrosMetodoDAO">Os parâmetros do método de retorno.</param>
        public LogAttribute(string campo, bool isCampoEFD, string campoDescricaoModel, Type tipoDAO, string campoIdModel,
            string nomeMetodoDAO, bool incluirValorPrimeiroParametro, params object[] parametrosMetodoDAO)
        ...
        public LogAttribute(TipoLog tipoLog, string campo, bool isCampoEFD, string campoDescricaoModel, Type tipoDAO, string campoIdModel,
            string nomeMetodoDAO, bool incluirValorPrimeiroParametro, params object[] parametrosMetodoDAO)
        {
            Campo = campo;
            TipoLog = tipoLog;
