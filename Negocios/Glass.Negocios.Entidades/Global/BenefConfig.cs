...
namespace Glass.Global.Negocios.Entidades
{
    ...
    public class BenefConfig : Colosoft.Business.Entity<Glass.Data.Model.BenefConfig>
    {
        ...
        public override Colosoft.Business.SaveResult Save(Colosoft.Data.IPersistenceSession session)
        {
            ...
            if (!Configuracoes.Beneficiamentos.PermitirControleSelecaoSimplesComCalculoQtd &&
                TipoControle == Glass.Data.Model.TipoControleBenef.SelecaoSimples && TipoCalculo == Glass.Data.Model.TipoCalculoBenef.Quantidade)
