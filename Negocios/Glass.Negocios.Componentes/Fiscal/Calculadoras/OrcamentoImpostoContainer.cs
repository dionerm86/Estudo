...
{
    /// <summary>
    /// Implementação do container de itens de imposto para o orçamento.
    /// </summary>
    class OrcamentoImpostoContainer : IItemImpostoContainer
    {
        #region Propriedades
        ...
        /// Orçamento.
        /// </summary>
        public Data.Model.Orcamento Orcamento { get; }
        ...
        /// Valor do frete
        /// </summary>
        public decimal ValorFrete => Orcamento.ValorEntrega;
