...
namespace Glass.Data.Helper
{
    public static class Config
    {
        ...
        public enum ConfigEnum
        {
            ...
            MaximoVendasM2 = 8,
            MaximoVendasPeriodo = 9,
            CobrarTranspasse = 10,
            ItensProdutosOrcamento = 11,
            ...
            AgruparEtiquetaCorEspessura = 33,
            LimiteDiarioMedicoes = 34,
            SIntegraRegistro70 = 35,
            ExibirEntradaEstoqueExpedicao = 36,
            AgruparProdutosGerarNFe = 37,
            ReservarFastDelivery = 38,
            ...
            ImagensPecasIndividuais = 69,
            ComissaoPedido = 70,
            MedidorPedido = 71,
            NegociarParcialmente = 72,
            ExibirImpressaoProjetoPedido = 73,
            ...
            BloquearAlteracaoPrecoCompra = 139,
            ...
            PermitirReabrirPedidoImpresso = 187,
            ...
            NaoPermitirAlterarNumeroParcelasNFeGeradaCompra = 254,
            ...
            CapacidadeProducaoPorSetor = 259,
            ...
            AlterarSituacaoProducaoPedidoManualmenteConsiderandoRelatoriosProducao = 270,
            ...
            PermitirSomenteLeituraPecaProntaCarregamento = 276,
            ExibirLojaCadastroPedido = 277,
            NumeroDiasIgnorarClientesRecemAtivosInativarAutomaticamente = 278,
            NaoDestacarIcmsStNotaFiscalMasExibirInfCompl = 279,
            BloquearExpedicaoApenasPecasProntas = 281,
            AliquotaPis = 282,
            AliquotaCofins = 283,
            ExpedirSomentePedidosLiberadosCarregamento = 284,
            ...
            FiltroFuncionarioCaixaDiario = 294,
            ControleMedicao = 295,
            ...
            ControleRastrearEquipeInst = 307,
            ControlePCP = 308,
            ...
            UsarCustoFornSugestaoCompra = 1020,
            AtualizarValorProdutoFinalizarCompraComBaseMarkUp = 1021,
            ExibicaoDescrBenefCustomizada = 1022,
            AbrirRelatorioAoFinalizar = 1023,
            PerguntarContinuarTelaAoCadastrar = 1024,
            UsarCustoBeneficiamento = 1025,
            ExibirDadosAdicionaisPedido = 1026,
            ...
            ExibirContasAReceberRecebidasUsuarioFiltrado = 1052,
            ExibirDebitoCredito = 1053,
            FiltroPadraoIncluirContasArquivoRemessa = 1054,
            ExibirPedidosLiberacaoDebitos = 1055,
            ForcarInstrucaoPadrao = 1056,
            ...
            LiberacoesAPrazoFormaPagtoAPrazoMovLib = 1062,
            ...
            OpcaoPadraoFiltroContasAntecipadasContasReceber = 1075,
            ...
            MovimentarCaixaAoQuitarCheque = 1112,
            ...
            ExibirTipoContabilRetrato = 1121,
            ...
            LimitarCredito = 1129,
            ExibirPercComissaoNaLista = 1130,
            ExibirRelatorioAoFinalizar = 1131,
            ...
            SomarFreteBcIpiNotasDeTerceiros = 1161,
            SeriePadraoNFe = 1162,
            CstIpiPadraoNotaEntrada = 1163,
            IpiIntegraBcPISCOFINS = 1164,
            UsarDANFESemLogo = 1165,
            ...
            GerarParcelasNotaPedidoAntigo = 1179,
            UsarProdutoCestaSeApenasVidros = 1180,
            ValidarEstoqueAntesDaEmissao = 1181,
            RemoverIpiTotalProdutoAoRatear = 1182,
            PercentualCargaTributariaParaClienteSimplesNacionalCfop5401Cst10 = 1183,
            ComplementoNomeArquivoRelatorio = 1184,
            ...
            UsarCreditoPadraoDesmarcado = 1215,
            NaoVendeVidro = 1216,
            ...
            PermitirDescontoPorProdutoSemSeparacao = 1233,
            PermitirInserirNovaLoja = 1234,
            ExibirCompraCaixa = 1235,
            ExibirConsultaProducaoECommerce = 1236,
            ExibiPrecoTabelaECommerce = 1237,
            ExibirCartaoNaoIdentificado = 1238,
            UsarControleEntregaInstalacao = 1239,
            SituacaoInicialDeptoTecnico = 1240,
            UsarSituacoesExtrasInstalacao = 1241,
            FiltrarPorLojaComoPadrao = 1242,
            PermitirAlterarSituacaoManualmente = 1243,
            ...
            MedicaoAlterarSituacaoCadastro = 1279,
            MedicaoApenasClienteCadastrado = 1280,
            MedicaoPermissaoAlterarTodos = 1281,
            ...
            CalcularDescontoAposAcrescimo = 1290,
            FiltroPadraoAtivoListagem = 1291,
            ApenasAdminImprimeOrcamento = 1292,
            OrdenarAgruparProdutosPorNumSeqItem = 1293,
            UsarValorPercTextoAcrescimo = 1294,
            ExibirLogotipo = 1295,
            ExibirControleLiberarOrcamento = 1296,
            OrdenaAmbientesPeloNome = 1297,
            PermitirRemoverComissionado = 1298,
            TipoOrcamentoPadrao = 1299,
            PermitirInserirSemTipoOrcamento = 1301,
            AtualizarDescricaoPaiAoInserirOuRemoverProduto = 1302,
            VerificarEstoqueAoInserirProduto = 1303,
            ...
            ConcatenarNomeArquivoCorteAoNumEtiqueta = 1325,
            CriarClone = 1326,
            ...
            NomeArquivoMesaNomeFml = 1346,
            NomeArquivoMesaRecriado = 1347,
            PermitirCancelarRetalhoSeNaoCanceladoOuVendido = 1348,
            ...
            SempreAgruparProdutosPorProdutoAlturaLargura = 1353,
            RedirecionarListaPedidosAoFinalizar = 1354,
            ...
            InformarAlteracaoPrecoTabela = 1365,
            ...
            AgruparAmbientesRelatorio = 1388,
            ExibirTotalML = 1389,
            ...
            ExibirCampoPrazoEntrega = 1394,
            BuscarEnderecoClienteSeEstiverVazio = 1395,
            AtualizarDataEntregaInserirProduto = 1396,
            ExibirM2ChapaDeVidro = 1397,
            BuscarDataEntregaDeHojeSeDataVazia = 1398,
            ExibirCreditoClienteAoBuscar = 1399,
            ImpedirDataPrimeiraParcelaInferiorDataEntrega = 1400,
            ConfirmarPedidoAoFinalizar = 1401,
            EsconderCamposDataEntrega = 1402,
            ExigirDataClienteInformadoReposicaoAoFinalizar = 1403,
            SelecionarLojaGerarPedidoReposicao = 1404,
            ExibirVerificarParcelas = 1405,
            ExibirRelatorio = 1406,
            ExibirTelaEmBrancoAoConfirmar = 1407,
            ...
            ExibirValorIPI = 1422,
            GerarEtiquetasProducaoFinalizarPCP = 1423,
            ...
            Acrescentar2mmPecaENaoUsarAresta = 1432,
            ...
            FiltrarAmbienteAoFiltrarPedCli = 1442,
            ...
            PermitirLeituraSemImpressaoPedidoProducao = 1447,
            ExibirPainelSetores = 1448,
            CancelarLeiturasSeUmaFalhar = 1449,
            ExibirObsProjeto = 1450,
            BloquearValorProdutoAbaixoDoMinimo = 1451,
            UsarRelatorioProdutosDiferente = 1452,
            ExibirImagemAoSelecionarProduto = 1453,
            ...
            ApenasAdminSyncAtivarModeloProjeto = 1460,
            ...
            ConcatenarDescontoAoTotalDoPedido = 1493,
