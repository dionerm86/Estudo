...
namespace Glass.Data.Model
{
	...
	public class MaterialItemProjeto : IProdutoCalculo, IMaterialItemProjeto
    {
        ...
        {
            get { return Glass.Global.CalculosFluxo.CalcM2Calculo(null, (uint)IdCliente, (int)Altura, Largura, Qtde, (int)IdProd, Redondo, Beneficiamentos.CountAreaMinima, ProdutoDAO.Instance.ObtemAreaMinima((int)IdProd), false, 0, true); }
        }
