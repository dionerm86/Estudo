...
namespace Glass.Data.DAL
{
    public sealed class ProdutoPedidoProducaoDAO : BaseDAO<ProdutoPedidoProducao, ProdutoPedidoProducaoDAO>
    {
        ...
        /// verificar se a leitura na produ��o no setor de Expedi��o foi feita corretamente.
        /// </summary>
        ...
        public void VerificarLeituraExpedicao(GDATransaction sessao, string etiqueta)
        {
            ...
            {
                throw new Exception($"O Item do carregamento {etiqueta} n�o possui leitura na expedi��o."); 
            }
        }
        ...
        public bool ValidarComposicao(GDASession sessao, string etiqueta, string etiquetasMateriaPrima)
        {
            ...
            bool pertenceComposicao;

            foreach (var etiquetaMateriaPrima in etiquetasMateriaPrima.Split(',').ToList())
            {
                pertenceComposicao = ProdutosPedidoEspelhoDAO.Instance.ObterIdProdPedParentByEtiqueta(sessao, etiquetaMateriaPrima) == idProdPedParent;
                if (!pertenceComposicao)
                    return false;
            ...
            bool selecionar, int idCorVidro, float espessuraVidro, uint numeroNFe)
        {
            ...
            string campos3 = selecionar ? @"
                ...
                ped.tipoPedido=" + (int)Pedido.TipoPedidoEnum.Producao + @" as PedidoProducao, cast(pt.qtde as decimal(12,2)) as qtde, sp.TipoCalculo, IF (sp.TipoCalculo = 1, pt.ValorVendido, pt.ValorVendido * @TotM) AS ValorTotal, '$$$' as Criterio" : "count(*)";
            ...
            string campos4 = selecionar ? @"
                ...
                f.nome as nomeFuncPerda, null as DataLiberacaoPedido, false as PedidoProducao, 1 as qtde, sp.TipoCalculoNf as TipoCalculo, IF (sp.TipoCalculo = 1, pnf.ValorUnitario, pnf.ValorUnitario * @TotM) AS ValorTotal, '$$$' as Criterio" : "count(*)";
