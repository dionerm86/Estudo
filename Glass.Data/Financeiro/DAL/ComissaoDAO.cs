...
namespace Glass.Data.DAL
{
    public sealed class ComissaoDAO : BaseDAO<Comissao, ComissaoDAO>
    {
        ...
        /// <summary>
        /// Método que verifica se o controle de comissao por contas recebidas está habilitado.
        /// </summary>
        ...
        /// <summary>
        /// Método que Obtem o identificador do funcionário para o identificador do pedido verificado.
        /// </summary>
        /// <param name="session">Sessão do GDA.</param>
        /// <param name="idPedido">Identificador do Pedido a ser verificado.</param>
        /// <returns>Retorna um inteiro Identificador do funcionário que deverá ser vinculado como Funcionário a receber comissao da conta gerada.</returns>
