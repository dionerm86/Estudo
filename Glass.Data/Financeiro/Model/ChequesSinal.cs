...
{
    [PersistenceBaseDAO(typeof(ChequesSinalDAO))]
    [PersistenceClass("cheques_sinal")]
    public class ChequesSinal : ModelBaseCadastro
    {
        #region Propriedades

        [PersistenceProperty("IDCHEQUESINAL", PersistenceParameterType.IdentityKey)]
        public int IdChequeSinal { get; set; }
