...
{
    [PersistenceBaseDAO(typeof(FotosPagtoDAO))]
    [PersistenceClass("fotos_pagto")]
    public class FotosPagto : IFoto
    {
        #region Propriedades
        ...
        {
            get { return (uint)IdPagto; }
            set { IdPagto = (int)value; }
        }

        public override IFoto.TipoFoto Tipo
        {
            get { return TipoFoto.Pagto; }
        }
