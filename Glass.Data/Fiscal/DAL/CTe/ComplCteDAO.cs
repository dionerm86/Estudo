...
{
    public sealed class ComplCteDAO : BaseDAO<ComplCte, ComplCteDAO>
    {
        //private ComplCteDAO() { }
        ...
        {
            string sql = "Select * From compl_cte Where 1";
        ...
        public ComplCte GetElement(uint idCte)
        {
            return GetElement(null, idCte);
        }

        public ComplCte GetElement(GDASession session, uint idCte)
        {
            try
            {
        ...
        public IList<ComplCte> GetList(string sortExpression, int startRow, int pageSize)
        {
