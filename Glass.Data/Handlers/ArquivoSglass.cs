        ...
        public void ProcessRequest(HttpContext context)
        {
            try
            {
                ...
                var lstProdPedEsp = ProdutosPedidoEspelhoDAO.Instance.GetForRpt(context.Request["idPedido"].StrParaUint(), context.Request["idCliente"].StrParaUint(),
                    ...
                    context.Request["tipoPedido"], context.Request["idsRotas"], context.Request["origemPedido"].StrParaInt(), Conversoes.StrParaInt(context.Request["pedidosConferidos"]), Conversoes.StrParaInt(context.Request["tipoVenda"]));
