...
namespace Glass.API.Backend.Models.Produtos.V1.CoresAluminio.CadastroAtualizacao
{
    /// <summary>
    /// Classe que encapsula os dados de cadastro ou atualização de uma cor de alumínio.
    /// </summary>
