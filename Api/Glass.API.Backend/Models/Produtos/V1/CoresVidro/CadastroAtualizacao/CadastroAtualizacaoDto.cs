...
namespace Glass.API.Backend.Models.Produtos.V1.CoresVidro.CadastroAtualizacao
{
    /// <summary>
    /// Classe que encapsula os dados de cadastro ou atualização de uma cor de vidro.
    /// </summary>
