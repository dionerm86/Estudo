...
{
    /// <summary>
    /// Classe que encapsula as permissões para o item na lista de processos de etiqueta.
    /// </summary>
    [DataContract(Name = "Permissoes")]
    public class PermissoesDto
    {
        /// <summary>
        /// Obtém ou define um valor que indica se o processo contém registros de log de alterações.
        /// </summary>
        [DataMember]
