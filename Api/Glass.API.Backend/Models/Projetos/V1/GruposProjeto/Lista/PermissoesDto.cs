...
{
    /// <summary>
    /// Classe que encapsula os dados de permissão da lista de grupos de projeto.
    /// </summary>
    [DataContract(Name = "Permissoes")]
    public class PermissoesDto
    {
        /// <summary>
        /// Obtém ou define um valor que indica se o grupo de projeto possui log de alterações.
        /// </summary>
        [DataMember]
