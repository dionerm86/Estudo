...
{
    /// <summary>
    /// Classe que encapsula as permissões para o item na lista de tipos de perda.
    /// </summary>
    [DataContract(Name = "Permissoes")]
    public class PermissoesDto
    {
        /// <summary>
        /// Obtém ou define um valor que indica se o tipo de perda contém registros de log de alterações.
        /// </summary>
        [DataMember]
